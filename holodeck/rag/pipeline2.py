...
def pipeline_prep(delete_collection: bool) -> None:
    ...
    embeddingClient = OllamaClient.get_embeddings_client(constants.OLLAMA_LOCAL_URL)
    logger.info("Setting up embedding model...")
    embeddingModel = OllamaClient.setup_embedding_model(embeddingClient, constants.DEFAULT_EMBEDDING_MODEL)    
